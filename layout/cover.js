...
<Carousel infiniteLoop="true" autoPlay={true} interval={5000} showStatus={false}	showThumbs={false}>
             ...
             <img src={item} alt=" "/>
              ...
              <a className="btn btn-success btn-lg d-none d-lg-block d-xl-block dfee" href="https://drive.google.com/file/d/19aBZ4IZEwq36BnQ_TJ_8h_azRdrsrWSn/view?usp=sharing" download>تحميل بروفايل الشركة</a>
